export default function SectionSobre() {
  return (
    ...
    >
      <h3 className="text-background mb-3 text-xs font-bold md:text-sm lg:mb-16 lg:text-xl">
        {/* Título da Seção */}
        &lt;SobreMim /&gt;
      </h3>
      {/* Primeiro Bloco: Alinhado à Esquerda */}
      <div className="mb-20 w-full self-start md:mb-28 lg:mb-40 lg:w-2/3">
        <h2 className="text-background mb-3 text-center text-2xl font-bold md:text-3xl lg:mb-6 lg:text-start lg:text-5xl">
          Momento atual
        </h2>
      ...
      <div className="w-full self-end lg:w-2/3">
        <h2 className="text-background mb-3 text-center text-2xl font-bold md:text-3xl lg:mb-6 lg:text-5xl">
          Formação
        </h2>
        <p className="text-base leading-relaxed text-zinc-400 lg:indent-8 lg:text-xl">
